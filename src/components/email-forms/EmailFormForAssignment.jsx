    ...
    return (
        <>
            <div className="w-full text-center bg-[#F2EFFF] text-black rounded-xl shadow-xl">
                ...
                <div className="box px-2 bg-blue-200 text-blue-700 font-semibold py-4 rounded-t-xl text-md sm:text-lg tracking-wide">15% Off! 🌟 on Your First Assignment</div>

                <div className="content px-3 sm:px-6 mt-6 pb-6">
                    <h2 className="mb-4 text-black text-2xl font-semibold">Need Professional Help with Your Assignments?<span className="text-[#1A73E8]"> Chat Now</span></h2>

                    <p className="mb-4 text-sm sm:text-md max-w-sm mx-auto">Achieve Top Grades Without the Stress - Connect with an Expert for Your Academic Needs!</p>
