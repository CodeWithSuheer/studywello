    ...
    return (
        <>
            <section className="mb-28 lg:mb-16 relative flex items-center justify-center">
                <div className='custom_shadow relative sm:absolute sm:-top-12 w-full sm:max-w-6xl mx-auto rounded-none sm:rounded-full bg-orange-400  px-5 sm:px-10 py-7 mb-5'>
